...
SESSION_OPTIONS = server.SessionOptions()
...
def get_reference_data(tickers, fields):
    session = server.Session(SESSION_OPTIONS)
    data = []
    error_message = None
    ...
    try:
        ...
        while not done:
            ...
            if ev.eventType() == server.Event.TIMEOUT:
                            ...
                            if field_data.hasElement(field):
                                try:
                                    ...
                                    try:
                                        ...
                                        pass # Noneのまま
                        data.append(row)
                done = ev.eventType() == server.Event.RESPONSE
